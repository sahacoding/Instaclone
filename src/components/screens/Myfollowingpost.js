...
//   };
  ...
  useEffect(() => {
    const asyncallPost = async () => {
        //const storelocalstorage = JSON.parse(localStorage.getItem('user'))
        //console.log('localstorage is', storelocalstorage)
      const response = await fetch("/api/post/fetchfollowingpost", {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          "auth-token": localStorage.getItem("token"),
      ...
      //  body: JSON.stringify(storelocalstorage.following)
